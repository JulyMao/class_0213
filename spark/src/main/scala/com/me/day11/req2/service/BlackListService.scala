...
import com.me.day11.UDAFdate
import com.me.day11.req2.bean.Ad_Click_Log
import com.me.day11.req2.dao.BlackListDao
...
class BlackListService extends TService{
    ...
    def main(args: Array[String]): Unit = {
      ...
      val uDAFdate = new UDAFdate
      spark.udf.register("all_days",uDAFdate)
      spark.sql(
        """
          |select sale.brand,all_days(sale.startdate,sale.enddate)
          |from sale
          |group by sale.brand
          |""".stripMargin).show()
    }
